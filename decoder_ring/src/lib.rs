...
// Function guess_shift iterates over all the 
// shifts, defined by the upper bound parameter depth,
// and compares the distribution of frequencies of letters in 
// "shifted" text with the most common distribution by calculation of 
// so-called closeness score. The shift with the highest closeness score
// should be the best candidate.
